return {
  { 'ms-jpq/chadtree', branch = 'chad', build =  'python3 -m chadtree deps', event = 'VeryLazy',
    config = function()
      g.chadtree_settings = { keymap = { v_split = {'z'}, h_split = {'Z'} } }
    end
  }, -- file manager
  ...
  -- { 'nvim-telescope/telescope.nvim', tag = '0.1.1', event = 'VeryLazy', config = true, -- big fuzzy finder dependencies = { 'nvim-lua/plenary.nvim', 'nvim-treesitter/nvim-treesitter' },
  -- },
